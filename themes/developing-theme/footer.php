...
<footer class="p-4 py-8 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl lg:py-16 lg:px-6 text-center">
      <div class="grid lg:grid-cols-2">
        <a href="/" class="flex items-center lg:w-1/4">
            ...
            <?php wp_nav_menu ([
                        'menu' => 'footer',
                        'container' => 'ul',
                        'menu_class' => 'flex flex-wrap items-center justify-center md:!justify-end gap-4 mb-4 text-sm text-gray-500 lg:mb-0',
      ...
      <div class="sm:items-center sm:justify-between sm:flex">
          <span class="block text-sm text-gray-500 dark:text-gray-400">© <?php echo date('Y'); ?> Redecem. Alle rechten voorbehouden. Ontwikkeld door <a href="https://developing.nl" target="_blank" class="hover:underline">Developing.</a></span>
